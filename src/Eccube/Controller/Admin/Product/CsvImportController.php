                ...
                if (!empty($formFile)) {
                    ...
                    foreach ($data as $row) {
                        ...
                        if ($ProductClasses->count() < 1) {
							...
							if ($tmpImportProductClass[$row[$headerByKey['id']]][$classCategoryId1]) continue;
                            ...
                            foreach ($ProductClasses as $pc) {
                                ...
                                if ($classCategory1 == $classCategoryId1 &&
									...
									$tmpImportProductClass[$row[$headerByKey['id']]][$classCategoryId1] = true;

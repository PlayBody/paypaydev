...
use Doctrine\ORM\Mapping as ORM;
    ...
    {
    use \Plugin\ProductPlus\Entity\ProductTrait, \Plugin\ProductDisplayRank4\Entity\ProductTrait, \Plugin\RelatedProduct4\Entity\ProductTrait;
...
/* 2021/09/14 Add by Katsumoto */					
					if ($ProductClass->getMember() == null) {
                        continue;
                    }
/* add end */
        ...
        /**
         * Get getProductClassesMarketPlace4.
         *	Added By katsumoto 2021/08/18
         * @return \Doctrine\Common\Collections\Collection
         */
        public function getProductClassesMarketPlace4()
        {
            /* 2021/08/14 Updated By Katsumoto Relation MarketPlace */

            $ProductClassesSort = [];
            foreach ($this->ProductClasses as $ProductClass){
                if ($ProductClass->getMember() == null) continue;
                if (!$ProductClass->getStockFind()){
                    $ProductClassesSort[] = $ProductClass;
                }
            }
            foreach ($this->ProductClasses as $ProductClass){
                if ($ProductClass->getMember() == null) continue;

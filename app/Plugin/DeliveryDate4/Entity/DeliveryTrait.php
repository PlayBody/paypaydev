...
trait DeliveryTrait
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Plugin\DeliveryDate4\Entity\DeliveryDate", mappedBy="Delivery", cascade={"persist","remove"})
     */
    ...
    public function addDeliveryDate(\Plugin\DeliveryDate4\Entity\DeliveryDate $deliveryDate)
    {
    ...
    public function removeDeliveryDate(\Plugin\DeliveryDate4\Entity\DeliveryDate $deliveryDate)
    {

...
class AmazonRequestService{
    ...
    public function createCheckoutSessionPayload($cart_key){
        ...
        $payload = [
            'webCheckoutDetails' => [
                'checkoutReviewReturnUrl' => $this->generateUrl('amazon_checkout_review', ['cart' => $cart_key], UrlGeneratorInterface::ABSOLUTE_URL)
            ],
    ...
    public function createUpdateCheckoutSessionPayload($Order){
        ...
        $payload = [
            'webCheckoutDetails' => [
                'checkoutResultReturnUrl' => $this->generateUrl('amazon_pay_shopping_checkout_result', [], UrlGeneratorInterface::ABSOLUTE_URL)
            ],
            'paymentDetails' => [

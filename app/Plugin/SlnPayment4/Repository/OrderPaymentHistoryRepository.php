...
class OrderPaymentHistoryRepository extends AbstractRepository
{
     ...
     * @param \Plugin\SlnPayment4\Service\SlnContent\Basic $basic
     * @return \Plugin\SlnPayment4\Entity\OrderPaymentHistory
     */
    protected function addLog($orderId, \Plugin\SlnPayment4\Service\SlnContent\Basic $basic)
    {
    ...
    public function getRevOrderIdForTid($transactionId)
    {
        ...
        $data = $em->createQuery(
            'SELECT o.id FROM Eccube\Entity\Order o JOIN Plugin\SlnPayment4\Entity\OrderPaymentHistory pay_h

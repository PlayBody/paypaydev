...
use Plugin\SlnPayment4\SlnException;
use Plugin\SlnPayment4\Service\Util;
use Plugin\SlnPayment4\Service\SlnAction\HttpSend;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Request\Add;
use Plugin\SlnPayment4\Service\SlnContent\Receipt\AddMaster;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Add as RespAdd;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\RefNotice;
use Plugin\SlnPayment4\Service\SlnContent\Receipt\RefProcess;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Request\Ref;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Ref as RefRep;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Request\Chg;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Chg as ChgRep;
use Plugin\SlnPayment4\Service\SlnContent\Receipt\ChgDelProcess;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Request\Del;
use Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Del as DelRep;
...
class Cvs
{
     ...
     * @return string[]|\Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Request\Add[]
     */
    public function Add(
     ...
     * @throws ShoppingException
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Add|mixed
     */
     ...
     * @throws ShoppingException
     * @return \Plugin\SlnPayment4\Service\SlnContent\Basic[]|unknown[]
     */
    public function Recv(\Plugin\SlnPayment4\Entity\ConfigSubData $config, Request $request)
    {
     ...
     * @param unknown $orderId
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\RefNotice
     */
     ...
     * @throws ShoppingException
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnContent\Receipt\RefProcess
     */
    public function Ref(
        \Eccube\Entity\Order $Order, 
        \Plugin\SlnPayment4\Entity\ConfigSubData $config, 
     ...
     * @param unknown $orderId
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Ref|mixed
     */
     ...
     * @throws ShoppingException
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnContent\Receipt\ChgDelProcess
     */
    public function Chg(
        \Eccube\Entity\Order $Order, 
        \Plugin\SlnPayment4\Entity\ConfigSubData $config, 
     ...
     * @param unknown $orderId
     * @throws SlnException
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Chg|mixed
     */
     ...
     * @param unknown $orderId
     * @throws SlnException
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Receipt\Response\Del|mixed
     */

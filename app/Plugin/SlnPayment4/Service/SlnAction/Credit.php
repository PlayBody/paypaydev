...
namespace Plugin\SlnPayment4\Service\SlnAction;
...
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Check;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Check as RespCheck;
use Plugin\SlnPayment4\Service\SlnContent\Credit\Master;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Auth;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Auth as RespAuth;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Gathering;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Gathering as RespGathering;
use Plugin\SlnPayment4\Entity\OrderPaymentHistory;
use Plugin\SlnPayment4\Service\SlnContent\Credit\Process;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Capture;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Capture as RespCapture;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Delete;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Delete as RespDelete;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Change;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Change as RespChange;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\Search;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Search as RespSearch;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\ReAuth;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\ReAuth as RespReAuth;
use Plugin\SlnPayment4\Exception\SlnShoppingException;
use Plugin\SlnPayment4\Service\Util;
use Plugin\SlnPayment4\Service\CryptAES;
use Plugin\SlnPayment4\Service\SlnContent\Credit\ThreeDMaster;
use Plugin\SlnPayment4\Service\SlnAction\HttpSend;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\ThreeDAuth;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Request\ThreeDGathering;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\ThreeDAuth as RespThreeDAuth;
use Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\ThreeDGathering as RespThreeDGathering;
...
class Credit
{
     ...
     * @param \Plugin\SlnPayment4\Entity\ConfigSubData $config
     * @param Master $master
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Check|mixed
     */
    public function Check( 
        \Eccube\Entity\Customer $Customer, 
        \Plugin\SlnPayment4\Entity\ConfigSubData $config, 
        Master $master)
    {
     ...
     * @param Master $master
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Auth|mixed
     */
     ...
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Capture|mixed
     */
        ...
        OrderPaymentHistory $history)
    {
        ...
        /* @var $kaiinHistory \Plugin\SlnPayment4\Entity\OrderPaymentHistory */
        $q = $this->entityManager->createQuery("SELECT h from \Plugin\SlnPayment4\Entity\OrderPaymentHistory h
     ...
     * @param OrderPaymentHistory $history
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Delete|mixed
     */
     ...
     * @param OrderPaymentHistory $history
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Change|mixed
     */
     ...
     * @param OrderPaymentHistory $history
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\Search|mixed
     */
     ...
     * @param OrderPaymentHistory $history
     * @throws \Exception
     * @return \Plugin\SlnPayment4\Service\SlnAction\Content\Credit\Response\ReAuth|mixed
     */
